...
html {
    scrollbar-width: none;
        ...
        .analytics-icon {
            width: 60px; /* Increased from 64px */
            height: 60px; /* Increased from 64px */
            border-radius: 12px;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .analytics-label {
            ...
            font-size: 1 rem; /* Increased from 0.95rem */
...
.cursor-pointer:hover {
    background-color: rgba(0, 123, 255, 0.1);
        ...
        .analytics-card[data-type="teaching"] .analytics-dots .dot {
            background-color: rgba(16, 185, 129, 0.3); /* Light green */
        }
        ...
        .analytics-card[data-type="other"] .analytics-dots .dot {
            background-color: rgba(236, 72, 153, 0.3); /* Light pink */
        }
        ...
        .analytics-card[data-type="other"] .analytics-dots .dot.active {
            background-color: #ec4899; /* Solid pink */
            transform: scale(1.5);
        }
