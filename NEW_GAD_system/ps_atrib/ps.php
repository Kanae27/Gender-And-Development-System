                ...
                <div class="tab-content" id="quarterTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="q1" role="tabpanel">
                        ...
                        <div class="action-buttons mb-3">
                            ...
                            <button type="button" class="btn btn-success" id="exportBtn1" disabled>
                    ...
                    <div class="tab-pane fade" id="q2" role="tabpanel">
                        ...
                        <div class="action-buttons mb-3">
                            ...
                            <button type="button" class="btn btn-success" id="exportBtn2" disabled>
                                <i class="fas fa-file-excel"></i> Export to Excel
                            </button>
                        </div>
                        <div class="table-responsive">
                    ...
                    <div class="tab-pane fade" id="q3" role="tabpanel">
                        ...
                        <div class="action-buttons mb-3">
                            ...
                            <button type="button" class="btn btn-success" id="exportBtn3" disabled>
                                <i class="fas fa-file-excel"></i> Export to Excel
                            </button>
                        </div>
                        <div class="table-responsive">
                    ...
                    <div class="tab-pane fade" id="q4" role="tabpanel">
                        ...
                        <div class="action-buttons mb-3">
                            ...
                            <button type="button" class="btn btn-success" id="exportBtn4" disabled>
                                <i class="fas fa-file-excel"></i> Export to Excel
                            </button>
                        </div>
                        <div class="table-responsive">
        ...
        function updatePSAttribution(quarter, ppaId) {
            ...
            .catch(error => {
                ...
                Swal.fire({
                    ...
                    footer: 'Check browser console and server logs for more details',
                    confirmButtonText: 'OK'
                });
