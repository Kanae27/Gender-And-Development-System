...
<head>
    ...
    <style>
        ...
        #yearOverviewChart .chartjs-render-monitor text {
            fill: #000000 !important; /* Black text in light mode */
...
body::-webkit-scrollbar {
    ...
    height: 300px;  /* Decreased from 250px to 200px */
        ...
        :root {
            --accent-color-rgb: 106, 27, 154; /* RGB equivalent of #6a1b9a */
        }

        [data-bs-theme="dark"] {
            --accent-color-rgb: 156, 39, 176; /* RGB equivalent of #9c27b0 */
        }
