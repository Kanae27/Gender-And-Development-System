    ...
    <script>
        ...
        document.getElementById('ppasForm').addEventListener('submit', function(e) {
            ...
            const data = isEditMode ? 
                { id: currentSignatoryId, name1, gad_head_secretariat: rank1, name2, vice_chancellor_rde: rank2, name3, chancellor: rank3, name4, asst_director_gad: rank4, name5, head_extension_services: rank5, campus } : 
                { name1, gad_head_secretariat: rank1, name2, vice_chancellor_rde: rank2, name3, chancellor: rank3, name4, asst_director_gad: rank4, name5, head_extension_services: rank5, campus };
