...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 30, 2025 at 06:35 AM
...
CREATE TABLE IF NOT EXISTS `narrative_forms` (
  ...
  `ppas_activity_title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
-- Dumping data for table `narrative_forms`
--

INSERT INTO `narrative_forms` (`id`, `ppas_id`, `ppas_activity_title`, `username`, `implementing_office`, `partner_agency`, `service_agenda`, `sdg`, `beneficiaries`, `tasks`, `general_objective`, `specific_objective`, `activity_title`, `activity_narrative`, `evaluation_result`, `survey_result`, `photos`, `created_at`, `updated_at`) VALUES
(3, 2, 'Test Activity1', 'Lipa', 'ee', 'fdd', '[\"Technical Assistance\"]', '[\"Quality Education\",\"Partnerships for the Goals\"]', '[{\"type\":\"Students\",\"internal_male\":\"1\",\"internal_female\":\"1\",\"external_male\":\"0\",\"external_female\":\"0\"},{\"type\":\"Faculty\",\"internal_male\":\"2\",\"internal_female\":\"2\",\"external_male\":\"0\",\"external_female\":\"0\"}]', '[{\"name\":\"2\",\"task\":\"2\"}]', '2', '2', '2', '2', '2', '2', '[]', '2025-03-30 14:30:44', '2025-03-30 14:30:44');
