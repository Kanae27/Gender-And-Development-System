...
<body>
    ...
    <div class="main-content">
        ...
        <!-- Budget Summary Card -->
        <div class="card mb-4" id="budgetSummaryCard" style="display: none;">
            <div class="card-header bg-light">
                <h5 class="card-title mb-0">Budget Summary by Year</h5>
            </div>
            <div class="card-body">
                <div id="budgetSummary">
                    <div class="text-center py-3">
                        <i class="fas fa-chart-pie text-muted fa-2x mb-3"></i>
                        <p class="text-muted">Select a year to view budget summary</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function loadReport() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    // Continue loading report data even if budget data fails
                    console.log('Continuing to load report data without budget data...');
        ...
        function loadReportData(selectedCampus, selectedYear, budgetData) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success' && response.data) {
                        // Process and display the report data, passing budget data
                        displayReport(response.data, budgetData);
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
        ...
        function displayReport(data, budgetData) {
            ...
            if (budgetData) {
                ...
                // Debug each value extraction
                console.log('Raw total_gaa:', budgetData.total_gaa);
                console.log('Raw total_gad_fund:', budgetData.total_gad_fund);
                
                // Try to parse values or use hardcoded test values for debugging
                totalGAA = budgetData.total_gaa ? parseFloat(budgetData.total_gaa) : 800.00; // Test value
                totalGADFund = budgetData.total_gad_fund ? parseFloat(budgetData.total_gad_fund) : 40.00; // Test value
                
                console.log('Parsed totalGAA:', totalGAA);
                console.log('Parsed totalGADFund:', totalGADFund);
            } else {
                // If no budget data, use test values for now
                console.log('No budget data, using test values');
                totalGAA = 800.00;
                totalGADFund = 40.00;
            }
            ...
            let html = `
                <div class="report-header text-center mb-4" style="font-size: 12px;">
                    <img src="../images/BatStateU-NEU-Logo.png" alt="BatStateU Logo" style="width: 80px; height: 80px; margin-bottom: 8px;">
                    <div class="header-text" style="line-height: 1.4;">
                        <p class="mb-0" style="font-size: 12px;">Republic of the Philippines</p>
                        <p class="mb-0" style="font-size: 12px; font-weight: bold;">BATANGAS STATE UNIVERSITY</p>
                        <p class="mb-0" style="font-size: 12px;">The National Engineering University</p>
                        <p class="mb-0" style="font-size: 12px;">Batangas City</p>
                    </div>
                    <div style="margin-top: 15px;">
                        <hr style="height: 3px; background-color: #000000; border: none; margin: 10px 0;">
                        <h4 style="font-size: 12px; font-weight: bold;">ANNUAL GENDER AND DEVELOPMENT (GAD) PLAN AND BUDGET</h4>
                        <h5 style="font-size: 12px;">FY ${data[0]?.year || ''}</h5>
                    </div>
                </div>
                ...
                <div class="mb-2">
                    <div class="row">
                        <div class="col-12">
                            <p class="mb-1" style="font-size: 12px;"><strong>Campus:</strong> ${data[0]?.campus || ''}</p>
                            <p class="mb-1" style="font-size: 12px;"><strong>Total GAA:</strong> ₱${totalGAA.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</p>
                            <p class="mb-1" style="font-size: 12px;"><strong>Total GAD Fund (5%):</strong> ₱${totalGADFund.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</p>
                        </div>
                    </div>
                </div>
                
                <div class="table-responsive">
                    <table class="table table-bordered" id="reportTable" style="font-size: 12px;">
                        <thead>
                            <tr style="background-color: #f8f9fa;">
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 10%;">Gender Issue and/or GAD Mandate</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 10%;">Cause of the Gender Issue</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 10%;">GAD Result Statement/GAD Objective</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 10%;">Relevant Agency MFO/PAP</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 18%; border-right: 1px solid #000;">GAD Activity</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 12%; border-left: 1px solid #000;">Output Performance Indicators and Target</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 10%;">GAD Budget</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 10%;">Source of Budget</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; width: 10%;">Responsible Unit/Office</th>
                            </tr>
                            <tr style="background-color: #f8f9fa;">
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px;">(1)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px;">(2)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px;">(3)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px;">(4)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; border-right: 1px solid #000;">(5)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px; border-left: 1px solid #000;">(6)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px;">(7)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px;">(8)</th>
                                <th style="text-align: center; background-color: #e9ecef; font-size: 12px;">(9)</th>
                            </tr>
                        </thead>
                        <tbody>
            `;
            ...
            if (!data || data.length === 0) {
                ...
                allCategories.forEach(category => {
                    ...
                    html += `
                        <tr>
                            <td colspan="9" class="category-header" style="font-size: 12px; font-weight: bold;">${category}</td>
                        </tr>
                    `;
                    ...
                    if (categoryData.length === 0) {
                        ...
                        html += `
                            <tr>
                                ...
                                <td style="font-size: 12px;">&nbsp;</td>
                                <td style="font-size: 12px;">&nbsp;</td>
                                <td style="font-size: 12px; width: 18%; border-right: 1px solid #000;">&nbsp;</td>
                                <td style="font-size: 12px; width: 12%; border-left: 1px solid #000;">&nbsp;</td>
                                <td style="font-size: 12px;">&nbsp;</td>
                                <td style="font-size: 12px;">&nbsp;</td>
                                <td style="font-size: 12px;">&nbsp;</td>
                            </tr>
                        ...
                        categoryData.forEach(item => {
                            ...
                            if (item.generic_activity) {
                                ...
                                cleanGeneric.forEach((act) => {
                                    formattedActivities += `${act.trim()}<br>`;
                                });
                            }
                            ...
                            const activity = item.generic_activity ? 
                                item.generic_activity.replace(/[\[\]"]/g, '').split(',').filter(act => act.trim())[0] : '';
                            
                            if (activity) {
                                formattedOutputs = `No. of activities in "${activity}" conducted - at least 1 activity.<br><br>`;
                                formattedOutputs += `No. of participants in "${activity}" - at least ${item.male_participants || '0'} male and ${item.female_participants || '0'} female participants.`;
                            }
                            
                            html += `
                                <tr>
                                    <td style="font-size: 12px;">${item.gender_issue || ''}</td>
                                    <td style="font-size: 12px;">${item.cause_of_issue || ''}</td>
                                    <td style="font-size: 12px;">${item.gad_objective || ''}</td>
                                    <td style="font-size: 12px;">${item.relevant_agency || ''}</td>
                                    <td style="font-size: 12px; width: 18%; border-right: 1px solid #000;">${formattedActivities}</td>
                                    <td style="font-size: 12px; width: 12%; border-left: 1px solid #000;">${formattedOutputs}</td>
                                    <td style="font-size: 12px;">₱${parseFloat(item.gad_budget || 0).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</td>
                                    <td style="font-size: 12px;">${item.source_of_budget || ''}</td>
                                    <td style="font-size: 12px;">${item.responsible_unit || ''}</td>
                                </tr>
                            `;
                        });
                    }
                ...
                html += `
                    <tr class="total-row" style="background-color: #f9f9fa; font-weight: bold !important;">
                        <td colspan="6" class="text-end" style="font-size: 12px;"><strong>Total GAD Budget</strong></td>
                        <td style="font-size: 12px;"><strong>₱${totalGADBudget.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</strong></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-size: 12px; padding: 8px;">
                            <p style="font-size: 12px; margin-bottom: 4px;"><strong>Prepared by:</strong></p>
                            <div style="text-align: center; margin-top: 50px;">
                                <p style="font-size: 12px; margin-bottom: 0; text-decoration: underline;">RICHELLE M. SULIT</p>
                                <p style="font-size: 12px; margin-top: 0;">GAD Head Secretariat</p>
                            </div>
                        </td>
                        <td colspan="4" style="font-size: 12px; padding: 8px;">
                            <p style="font-size: 12px; margin-bottom: 4px;"><strong>Approved by:</strong></p>
                            <div style="text-align: center; margin-top: 50px;">
                                <p style="font-size: 12px; margin-bottom: 0; text-decoration: underline;">ATTY. ALVIN R. DE SILVA</p>
                                <p style="font-size: 12px; margin-top: 0;">Chancellor</p>
                            </div>
                        </td>
                        <td colspan="2" style="font-size: 12px; padding: 8px;">
                            <p style="font-size: 12px; margin-bottom: 10px;"><strong>Date</strong></p>
                            <p style="font-size: 12px; margin-top: 60px;">${new Date().toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                        </td>
                    </tr>
                `;
            }
                    ...
                    <style>
                        ...
                        @media print {
                            * {
                            ...
                            /* Connected columns */
                            .table td[style*="border-right: none"] {
                                border-right: none !important;
                            }
                            .table td[style*="border-left: none"] {
                            ...
                            /* Force table totals to show */
                            tr.total-row td:first-child {
                                page-break-before: avoid !important;
                            }
                            
                            tr.total-row td.text-end {
                            ...
                            /* Signature table styles for print */
                            .report-footer table {
                                width: 100%;
                                border-collapse: collapse;
                                border: 1px solid black !important;
