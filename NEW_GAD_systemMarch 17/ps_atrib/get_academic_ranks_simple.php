...
try {
    ...
    if ($tableExists) {
        ...
        if (count($academicRanks) > 0) {
            ...
            error_log("PPAS Title (Simple): " . $ppasTitle);
            error_log("Total Personnel in PPAS (Simple): " . $totalPersonnel);
            error_log("Role Counts (Simple): " . print_r($roleCountMap, true));
            ...
            if ($projectLeaderCount > 0 && !empty($highRanks)) {
                ...
                foreach ($highRanks as $rank) {
                    ...
                    $processedRanks[$rank['rank_name']]['personnel_count'] += $allocate;
            ...
            // Convert to array for output and sort by monthly salary (ascending)
            $sortedRanks = array_values($processedRanks);
            ...
            echo json_encode([
                'success' => true,
                'academicRanks' => $sortedRanks
            ]);
            exit;
        }
    }
    
    // If no data found, provide default academic ranks with zero personnel counts
    $academicRanks = [
        ['id' => 1, 'rank_name' => 'Instructor I', 'monthly_salary' => 31000, 'personnel_count' => 0],
        ['id' => 2, 'rank_name' => 'Instructor II', 'monthly_salary' => 35000, 'personnel_count' => 0],
        ['id' => 3, 'rank_name' => 'Instructor III', 'monthly_salary' => 43000, 'personnel_count' => 0],
        ['id' => 4, 'rank_name' => 'College Lecturer', 'monthly_salary' => 50000, 'personnel_count' => 0],
        ['id' => 5, 'rank_name' => 'Senior Lecturer', 'monthly_salary' => 55000, 'personnel_count' => 0],
        ['id' => 6, 'rank_name' => 'Master Lecturer', 'monthly_salary' => 60000, 'personnel_count' => 0],
        ['id' => 7, 'rank_name' => 'Assistant Professor II', 'monthly_salary' => 65000, 'personnel_count' => 0],
        ['id' => 8, 'rank_name' => 'Associate Professor I', 'monthly_salary' => 70000, 'personnel_count' => 0],
        ['id' => 9, 'rank_name' => 'Associate Professor II', 'monthly_salary' => 75000, 'personnel_count' => 0],
        ['id' => 10, 'rank_name' => 'Professor I', 'monthly_salary' => 80000, 'personnel_count' => 0],
        ['id' => 11, 'rank_name' => 'Professor II', 'monthly_salary' => 85000, 'personnel_count' => 0],
        ['id' => 12, 'rank_name' => 'Professor III', 'monthly_salary' => 90000, 'personnel_count' => 0],
        ['id' => 13, 'rank_name' => 'Professor IV', 'monthly_salary' => 95000, 'personnel_count' => 0]
    ];
    
    echo json_encode([
        'success' => true,
        'academicRanks' => $academicRanks,
        'message' => 'Using default academic ranks with zero personnel counts as no table data was found'
    ]);
